function Info() {
    return (
        <div className="window font-sans m-3 text-black dark:text-white row-span-3">
            ...
            <ul className="text-lg md:text-xl mt-1 list-disc list-inside">
                ...
                <li><span className="font-mono">sep:</span> Models with &quot;&lt;sep&gt;&quot; instead of &quot;1.&quot; for separation</li>
                <li><span className="font-mono">numsep:</span> Models &quot;&lt;1&gt;&quot; instead of &quot;1.&quot; for separation</li>
            </ul>
            <hr className="mt-5" />
            <h2 className="text-2xl md:text-3xl text-black dark:text-white font-bold mt-1">Metrics</h2>
            <table className="mt-1 table-fixed border-spacing-3 w-full border-separate border border-slate-500">
                <thead>
